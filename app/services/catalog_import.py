...
imports it into the `Item` table - the ERP sync mechanism for the item
catalogue, moved here with the table it populates.
...
original ItemDescription is never modified.
"""
...
from app.services.item_normalization import normalize_item_text
...
def load_catalog(path: str) -> list[CatalogRow]:
    ...
    rows) are skipped - they carry no catalog information, not a data
    error."""
